...
// Class Atributes
#define AFECS 2        // Chip Select ADE7758
...
#define RESET_bit 0x2000    // bit 13 - Indicates that the 5 V power supply is below 4 V. Enables a software reset of the ADE7758 and sets the registers back to their default values. This bit in the STATUS or RSTATUS register is logic high for only one clock cycle after a reset event.
